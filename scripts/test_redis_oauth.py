...
def main():
    ...
    if failed == 0:
        ...
        print("    2. Check CACHE_REDIS_URL in environment: docker-compose exec web_wsgi env | grep CACHE")
        print("    3. Test Redis directly: docker-compose exec redis redis-cli -a redis123 ping")
