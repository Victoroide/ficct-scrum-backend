...
def main():
    ...
    success, output = run_command(
        "python manage.py test apps.ai_assistant.tests.test_similar_issues_validation --verbosity=2",
    ...
    success, output = run_command(
        'python -c "from apps.ai_assistant.viewsets import AIAssistantViewSet; print(\'OK\')"',
    ...
    if os.path.exists(doc_file):
        ...
        with open(doc_file, 'r', encoding='utf-8') as f:
            ...
            if "ERROR #1" in content and "ERROR #2" in content:
                ...
                print_result("Documentation complete", False, "Missing error documentation")
    else:
