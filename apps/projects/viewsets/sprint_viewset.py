...
class SprintViewSet(viewsets.ModelViewSet):
    ...
    def start_sprint(self, request, pk=None):
        ...
        committed_points = sprint.issues.filter(
            is_active=True
    ...
    def progress(self, request, pk=None):
        ...
        progress_data = {
            ...
            "completion_percentage": round((completed_issues / total_issues * 100) if total_issues > 0 else 0, 2),
            "points_completion_percentage": round((completed_points / total_points * 100) if total_points > 0 else 0, 2),
    ...
    def burndown(self, request, pk=None):
        ...
        for day in range(duration + 1):
            ...
            actual_line.append({
                ...
                "remaining_points": round(remaining, 2) if remaining is not None else None
            })
