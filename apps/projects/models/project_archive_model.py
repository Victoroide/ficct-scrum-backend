...
class ProjectArchive(models.Model):
    ...
    project = models.OneToOneField(
        "projects.Project", on_delete=models.CASCADE, related_name="archive_info"
    )
    reason = models.CharField(
        max_length=20, choices=ARCHIVE_REASON_CHOICES, default="completed"
    )
    description = models.TextField(
        blank=True, help_text="Additional details about why the project was archived"
    )
