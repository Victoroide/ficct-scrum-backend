    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            for user_data in demo_users:
                ...
                self.stdout.write(self.style.SUCCESS(f'Created {user_data["role"]} user: {user.email}'))
            
            self.stdout.write(self.style.SUCCESS('\nAll demo users created successfully!'))
            self.stdout.write(self.style.SUCCESS('\nLogin Credentials:'))
            self.stdout.write(self.style.SUCCESS('------------------'))
            self.stdout.write(self.style.SUCCESS(f'Superuser: superuser@ficct.com / Pass123'))
            ...
            self.stdout.write(self.style.SUCCESS(f'Manager: manager@ficct.com / Pass123'))
