...
class ReportEndpointTestCase(TestCase):
    ...
    def test_velocity_invalid_project_uuid(self):
        ...
        response = self.client.get('/api/v1/reporting/reports/velocity/?project=invalid-uuid')
    ...
    def test_velocity_nonexistent_project(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/velocity/?project={fake_uuid}')
    ...
    def test_velocity_no_permission(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/velocity/?project={self.project.id}')
    ...
    def test_velocity_invalid_num_sprints(self):
        ...
        # Test non-integer
        response = self.client.get(f'/api/v1/reporting/reports/velocity/?project={self.project.id}&num_sprints=abc')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        
        # Test out of range
        response = self.client.get(f'/api/v1/reporting/reports/velocity/?project={self.project.id}&num_sprints=100')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_sprint_report_invalid_sprint_uuid(self):
        ...
        response = self.client.get('/api/v1/reporting/reports/sprint-report/?sprint=invalid-uuid')
    ...
    def test_sprint_report_nonexistent_sprint(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/sprint-report/?sprint={fake_uuid}')
    ...
    def test_sprint_report_no_permission(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/sprint-report/?sprint={self.sprint.id}')
    ...
    def test_team_metrics_invalid_period(self):
        ...
        # Test non-integer
        response = self.client.get(f'/api/v1/reporting/reports/team-metrics/?project={self.project.id}&period=abc')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        
        # Test out of range
        response = self.client.get(f'/api/v1/reporting/reports/team-metrics/?project={self.project.id}&period=500')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_team_metrics_success(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/team-metrics/?project={self.project.id}')
    ...
    def test_cumulative_flow_invalid_days(self):
        ...
        # Test non-integer
        response = self.client.get(f'/api/v1/reporting/reports/cumulative-flow/?project={self.project.id}&days=abc')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        
        # Test out of range
        response = self.client.get(f'/api/v1/reporting/reports/cumulative-flow/?project={self.project.id}&days=200')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_cumulative_flow_success(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/cumulative-flow/?project={self.project.id}')
    ...
    def test_dashboard_success(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/dashboard/?project={self.project.id}')
    ...
    def test_list_snapshots_success(self):
        ...
        response = self.client.get(f'/api/v1/reporting/reports/?project={self.project.id}')
...
class DiagramEndpointTestCase(TestCase):
    ...
    def test_list_diagrams_no_permission(self):
        ...
        response = self.client.get(f'/api/v1/reporting/diagrams/?project={self.project.id}')
