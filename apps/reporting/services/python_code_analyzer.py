...
class PythonCodeAnalyzer:
    ...
    def _extract_class_info(self, class_name: str, content: str, inheritance: str) -> Dict:
        """
        ...
        for match in self.IMPORT_PATTERN.finditer(content):
            ...
            for item in items:
                ...
                imports.append({
                    ...
                    'is_relative': from_module and from_module.startswith('.') if from_module else False
                })
