...
class UMLGenerator:
    ...
    def generate_uml_json(self, analysis: Dict, integration) -> Dict:
        ...
        import_relationships = self._extract_import_relationships(
            analysis["dependencies"], filtered_classes  # Only consider filtered classes
        )
    ...
    def _extract_class_relationships(
        self, class_info: Dict, all_classes: Dict
    ) -> List[Dict]:
        """
        ...
        for parent in class_info.get("parent_classes", []):
            ...
            parent_exists = any(cls["name"] == parent for cls in all_classes.values())
    ...
    def _extract_import_relationships(
        self, dependency_graph: Dict, all_classes: Dict
    ) -> List[Dict]:
        """
