...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = [
            'id', 'name', 'slug', 'description', 'logo', 'website_url',
            'organization_type', 'subscription_plan', 'owner', 'organization_settings',
            'is_active', 'member_count', 'workspace_count', 'user_role',
...
class OrganizationInvitationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'organization', 'email', 'role', 'status', 'invited_by',
            'message', 'expires_at', 'accepted_at', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'organization', 'invited_by', 'status', 'expires_at',
...
class WorkspaceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'workspace_type', 'visibility', 'workspace_settings', 'is_active',
            'created_by', 'member_count', 'project_count', 'user_role',
            'created_at', 'updated_at'
        ]
    ...
    def validate_slug(self, value):
        organization = self.context.get('organization')
        if self.instance:
            if Workspace.objects.exclude(id=self.instance.id).filter(
                organization=organization,
                slug=value
            ).exists():
...
class WorkspaceMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'workspace', 'user', 'role', 'permissions',
