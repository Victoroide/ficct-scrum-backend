...
@extend_schema_view(
    list=extend_schema(
        tags=["Logging"], operation_id="error_logs_list", summary="List Error Logs"
    ),
    retrieve=extend_schema(
        tags=["Logging"],
        operation_id="error_logs_retrieve",
        summary="Get Error Log Details",
    ),
    update=extend_schema(
        tags=["Logging"], operation_id="error_logs_update", summary="Update Error Log"
    ),
    partial_update=extend_schema(
        tags=["Logging"],
        operation_id="error_logs_partial_update",
...
class ErrorLogViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        tags=["Logging"], operation_id="error_logs_resolve", summary="Resolve Error Log"
    )
