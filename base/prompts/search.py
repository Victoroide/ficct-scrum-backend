...
class SearchPrompts:
    ...
    def enhance_query_llama4(
        user_query: str, context: str = None
    ) -> List[Dict[str, str]]:
        """
    ...
    @staticmethod
    def enhance_query_openai(user_query: str) -> List[Dict[str, str]]:
        """
    ...
    def summarize_search_results_llama4(
        query: str, results: List[Dict], max_results: int = 5
    ) -> List[Dict[str, str]]:
        """
