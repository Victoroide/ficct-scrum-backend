...
class AzureProvider(BaseLLMProvider):
    ...
    PRICING = {
        ...
        ModelType.AZURE_GPT4: (30.00, 60.00),       # $30 input, $60 output per 1M tokens (fallback)
    }
    ...
    def __init__(self, model_type: ModelType = ModelType.AZURE_O4_MINI):
        ...
        try:
            ...
            logger.info(f"[AZURE] Using deployment: {self.azure_service.chat_deployment}")
    ...
    def generate(
        ...
        **kwargs
        ...
        try:
            logger.info(f"[AZURE] Generating with {self.model_name}, max_tokens={max_tokens}, temp={temperature}")
